...
public interface CatalogAdministration {
    ...
    void saveMenuItem(Integer id, String name, Integer categoryId, String description, Integer sortOrder,
    ...
    void savePizzaCategory(Integer id, String name, Integer sortOrder, Map<String, String> parameters, String actor);

    void saveMenuCategory(Integer id, String name, Integer sortOrder, Map<String, String> parameters, String actor);

    void savePizzaSize(Integer id, Integer cm, Integer sortOrder, Map<String, String> parameters, String actor);

    void savePriceCategory(Integer id, String name, Integer sortOrder, Map<String, String> parameters, String actor);
