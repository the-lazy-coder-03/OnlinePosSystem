...
@Embeddable
public class OrderBurgerRemovedComponentId implements Serializable {
    private Long orderMenuItemId;
    private Integer componentId;

    public OrderBurgerRemovedComponentId() {
    }

    public OrderBurgerRemovedComponentId(Long orderMenuItemId, Integer componentId) {
    ...
    public boolean equals(Object o) {
        ...
        OrderBurgerRemovedComponentId that = (OrderBurgerRemovedComponentId) o;
