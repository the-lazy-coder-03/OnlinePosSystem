...
public class RouteTest {
    ...
    public void testCheckoutPageUsesIntegratedCustomerAndCartTemplate() throws Exception {
        mockMvc.perform(get("/checkout"))
                ...
                .andExpect(content().string(containsString("id=\"gateAccessCode\"")))
                .andExpect(content().string(containsString("<legend>Estate access</legend>")))
                .andExpect(content().string(containsString("maxlength=\"64\"")))
                .andExpect(content().string(containsString("pattern=\"[A-Za-z0-9 #*]*\"")))
